...
let container = document.querySelector(`.albumsredaction`);
let tracks = document.querySelector(`.playlistsredaction`);
...
function renderAlbumInfo(){
    ...
    <div class="card mb-3">
        <div class='row'>
            <div class='col-4'>
                <img src="${album.img}" alt="" class="img-fluid img-albumsred rounded-start">
            </div>
...
function renderTraks(){
    ...
    for (let i=0; i<playlist.length; i++){
        ...
        <li class="list-group-item d-flex align-items-center track">
            ...
            <div>
                <div class='ms-3' style="width: 200px; font-weight: 700;">${track.title}</div>
                <div class='ms-3' style="width: 200px; font-weight: 200;">${track.author}</div>
            </div>
